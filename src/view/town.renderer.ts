...
function buildMarker(markerLayer: L.LayerGroup, commune: Commune, radius: number, hue: number, popupLabel: string, markerOnClick: (event: Event) => void, props: string[], left: boolean) {
...
export function renderMarkerPerCommune(markerLayer: L.LayerGroup, commune: Commune, markerOnClick: (event: Event) => void) {
  ...
  buildMarker(markerLayer, commune, radiusLeft, hueLeft, popupLabel, markerOnClick, props, true);
  buildMarker(markerLayer, commune, radiusRight, hueRight, popupLabel, markerOnClick, props, false);
}
